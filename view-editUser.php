      ...
      <div class="col-sm-12 col-md-6 col-lg-8">
        ...
        <div class="modal-content" style="margin-bottom:30px;">
          <div class="modal-header bg-light align-items-center">
            <h5 class="modal-title font-title" style="margin-left:10px;" id="exampleModalLabel">Editar Usuario</h5>
            ...
            <form action="index.php" method="post">
              ...
              <div class="modal-footer d-flex justify-content-end">
                ...
                <input type="hidden" name="user_id"
                  value=<?php if(isset($user_info['user_id'])){echo $user_info['user_id'];}?>>
              </div>
            </form>
          </div>
